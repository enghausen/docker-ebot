...
sed -i "s/SSL_ENABLED =.*/SSL_ENABLED = \"$SSL_ENABLED\"/g" $CONFIG_FILE
sed -i "s/SSL_CERTIFICATE_PATH =.*/SSL_CERTIFICATE_PATH = \"$SSL_CERTIFICATE_PATH\"/g" $CONFIG_FILE
sed -i "s/SSL_KEY_PATH =.*/SSL_KEY_PATH = \"$SSL_KEY_PATH\"/g" $CONFIG_FILE
